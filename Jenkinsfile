pipeline {
     environment {
       ...
       APP_NAME = "ulrich"
       STG_API_ENDPOINT = "ip10-0-84-7-ctinriml795g00fta2s0-1993.direct.docker.labs.eazytraining.fr"
       STG_APP_ENDPOINT = "ip10-0-84-7-ctinriml795g00fta2s0-80.direct.docker.labs.eazytraining.fr"
       PROD_API_ENDPOINT = "ip10-0-84-6-ctinriml795g00fta2s0-1993.direct.docker.labs.eazytraining.fr"
       PROD_APP_ENDPOINT = "ip10-0-84-6-ctinriml795g00fta2s0-80.direct.docker.labs.eazytraining.fr"
       INTERNAL_PORT = "5000"
